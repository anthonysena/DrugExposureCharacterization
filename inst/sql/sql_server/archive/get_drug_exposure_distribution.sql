...
FROM @results_database_schema.dus_dist d 
INNER JOIN @cdm_database_schema.concept c ON d.concept_id = c.concept_id
INNER JOIN @results_database_schema.dus_overview o ON o.concept_id = d.concept_id AND o.field_name = d.field_name
